...
#SBATCH --job-name=brca_tcga_snkg
#SBATCH --mail-user=george.bouras@adelaide.edu.au
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --mail-type=FAIL
#SBATCH --err="brca_tcga_snk.err"
#SBATCH --output="brca_tcga_snk.out"
...
--config Reads=/hpcfs/users/a1667917/Eric/BRCA_Bams/ Output=/hpcfs/users/a1667917/Eric/BRCA_Output \
