...
snakemake  -s /hpcfs/users/a1667917/Kevin/WGS_TCGA_Kraken_Pipeline/wgs_runner.smk  --config Reads=/hpcfs/users/a1667917/Kevin/TCGA_WGS_Total_Bams/Single Output=/hpcfs/users/a1667917/Kevin/TCGA_WGS_Output_Single  --profile wgs_tcga
